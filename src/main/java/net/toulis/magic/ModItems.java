...
public class ModItems {
    ...
    public static final Item SPELL_CONTINUE = register("spell_continue", ContinueSpell::new, new Item.Settings());
    ...
    public static final Item SPELL_RANDOM_POTION = register("spell_random_potion", RandomPotionSpell::new, new Item.Settings());
